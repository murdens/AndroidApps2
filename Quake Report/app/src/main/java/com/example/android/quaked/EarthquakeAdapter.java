...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Get original place of earthquake
        // example of original string "86km E of Old Iliamna, Alaska"
        String currentPlace = currentEarthquake.geteCity();
        ...
        if (currentPlace.contains(LOCATION_SEPARATOR)) {
            ...
            distance = parts[0] + LOCATION_SEPARATOR.trim();
            city = parts[1].trim();
        } else {
    ...
    // helper method to convert double magnitude into int and switch statement to assign colour.
