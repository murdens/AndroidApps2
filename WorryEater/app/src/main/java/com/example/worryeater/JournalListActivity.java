...
import com.example.worryeater.ui.JournalRecyclerAdapter;
...
public class JournalListActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        Log.d(TAG, "onStart: userId" + JournalApi.getInstance().getUserId());
        Log.d(TAG, "onStart: collection" + collectionReference.getId());
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                if (!queryDocumentSnapshots.isEmpty()){
                    ...
                    for (QueryDocumentSnapshot journals : queryDocumentSnapshots){
                        JournalData journal = journals.toObject(JournalData.class);
                        journalDataList.add(journal);
                    }
                    // invoke recycler view
                    journalRecyclerAdapter = new JournalRecyclerAdapter(
                            JournalListActivity.this, journalDataList);
