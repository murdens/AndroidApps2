...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // work out what was used to move to edit activity
        Intent intent = getIntent();
        mCurrentPetUri = intent.getData();

        // if doesn't include any existing pet data then need to add new.
        if (mCurrentPetUri == null) {
            // New pet to be added
            setTitle("Add a Pet");

            // Invalidate the options menu, hide delete.
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        // If cursor null or there is less than 1 row in the cursor, return.
        if (cursor == null || cursor.getCount() < 1) {
            return;
        }

        // First row of the cursor and reading data from it
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        mPetImage.setImageURI(Uri.parse(""));
    }
    ...
    private void deletePet() {
        ...
        if (mCurrentPetUri != null) {
            ...
            if (rowsDeleted == 0) {
                Toast.makeText(EditorActivity.this, R.string.editor_delete_pet_failed,
                        Toast.LENGTH_SHORT).show();
            } else {
